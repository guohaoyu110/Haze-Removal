...
% left_input = imread('/srv/glusterfs/daid/data/cityscape/leftImg8bit/train/aachen/aachen_000001_000019_leftImg8bit.png');
% right_input = imread('/srv/glusterfs/daid/data/cityscape/rightImg8bit/train/aachen/aachen_000001_000019_rightImg8bit.png');
% left_input_disparity = imread('/srv/glusterfs/daid/data/cityscape/disparity/train/aachen/aachen_000001_000019_disparity.png');
% camera_parameters_file = '/srv/glusterfs/csakarid/data/Cityscapes/camera_trainvaltest/camera/train/aachen/aachen_000001_000019_camera.json';

% left_input = imread('/srv/glusterfs/daid/data/cityscape/leftImg8bit/train/cologne/cologne_000088_000019_leftImg8bit.png');
% right_input = imread('/srv/glusterfs/daid/data/cityscape/rightImg8bit/train/cologne/cologne_000088_000019_rightImg8bit.png');
% left_input_disparity = imread('/srv/glusterfs/daid/data/cityscape/disparity/train/cologne/cologne_000088_000019_disparity.png');
% camera_parameters_file = '/srv/glusterfs/csakarid/data/Cityscapes/camera_trainvaltest/camera/train/cologne/cologne_000088_000019_camera.json';

left_input = imread('/srv/glusterfs/daid/data/cityscape/leftImg8bit/train/dusseldorf/dusseldorf_000020_000019_leftImg8bit.png');
right_input = imread('/srv/glusterfs/daid/data/cityscape/rightImg8bit/train/dusseldorf/dusseldorf_000020_000019_rightImg8bit.png');
left_input_disparity = imread('/srv/glusterfs/daid/data/cityscape/disparity/train/dusseldorf/dusseldorf_000020_000019_disparity.png');
camera_parameters_file = '/srv/glusterfs/csakarid/data/Cityscapes/camera_trainvaltest/camera/train/dusseldorf/dusseldorf_000020_000019_camera.json';

% left_input = imread('/srv/glusterfs/daid/data/cityscape/leftImg8bit/train/hamburg/hamburg_000000_046078_leftImg8bit.png');
% right_input = imread('/srv/glusterfs/daid/data/cityscape/rightImg8bit/train/hamburg/hamburg_000000_046078_rightImg8bit.png');
% left_input_disparity = imread('/srv/glusterfs/daid/data/cityscape/disparity/train/hamburg/hamburg_000000_046078_disparity.png');
% camera_parameters_file = '/srv/glusterfs/csakarid/data/Cityscapes/camera_trainvaltest/camera/train/hamburg/hamburg_000000_046078_camera.json';
...
% delta = 8;
% photoconsistency_mask = sum((rgb2lab(rgb_left_image) - rgb2lab(rgb_right_image_aligned)) .^ 2, 3) <= delta ^ 2 &...
%     mapped_inside_border;

M_L = ~photoconsistency_mask | is_depth_invalid;
...
%% Inspect how the depth values look like in a completely visible segment

segment_current_id = completely_visible_indices(100);
segment_current = S_L == segment_current_id;
...
upper_right_triangles_origins = segment_current & segment_sample_translated_dr & segment_sample_translated_r;
lower_left_triangles_origins = segment_current & segment_sample_translated_dr & segment_sample_translated_d;
tri = [find(upper_right_triangles_origins), find(imtranslate(upper_right_triangles_origins, [-1, -1]) & segment_current), find(imtranslate(upper_right_triangles_origins, [-1, 0]) & segment_current);
    find(lower_left_triangles_origins),  find(imtranslate(lower_left_triangles_origins, [-1, -1]) & segment_current),  find(imtranslate(lower_left_triangles_origins, [0, -1]) & segment_current)];
...
% Transmission map. Compute 3 different versions:
...
% 1)
t = transmission_exponential(depth, beta);

% 2)
t_filled = transmission_exponential(depth_filled, beta);

% 3) Apply guided image filtering to the transmission map that has been computed
%    from the filled depth map, using the original clean image as the guidance
%    image.
...
% Hazy image using transmission map and atmospheric light. Try 3 different ways
% to set the value of atmospheric light:
% 1) manual setting.
...
%% Show haze synthesis result with marked wrong disparities
...
I_annotated_inconsistent_only = mask_color_image(I,...
    ~photoconsistency_mask & ~is_depth_invalid, mask_color);
